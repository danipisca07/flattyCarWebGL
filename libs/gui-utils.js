 function setupUI(){
    ...
    webglLessonsUI.setupSlider("#cameraZ", {value: cameraPosition[2], slide: updateCameraPosition(2), min: -500, max: 500});
    webglLessonsUI.setupSlider("#cameraAngleX", {value: radToDeg(cameraRotation[0]), slide: updateCameraRotation(0), max: 360});
    webglLessonsUI.setupSlider("#cameraAngleY", {value: radToDeg(cameraRotation[1]), slide: updateCameraRotation(1), max: 360});
    webglLessonsUI.setupSlider("#cameraAngleZ", {value: radToDeg(cameraRotation[2]), slide: updateCameraRotation(2), max: 360});
