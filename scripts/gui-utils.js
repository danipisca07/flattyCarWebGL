function setupUI(){
    ...
    webglLessonsUI.setupSlider("#x", {value: translation[0], slide: updatePosition(0), min: -10, max: 10 });
    webglLessonsUI.setupSlider("#y", {value: translation[1], slide: updatePosition(1), min: -10, max: 10});
    webglLessonsUI.setupSlider("#z", {value: translation[2], slide: updatePosition(2), min: -10, max: 10});
